define([ 'app', 'app/services/menu.service', 'app/dialogs/sign.in.controller',
		'app/services/actions.service' ], function(app) {
	app.controller('MainController', function($scope, $rootScope, $document,
			$location, menuService, $mdDialog, $state, actionsService) {
		...
		$rootScope.$on('signInEvent', function(event, username) {
